...
| [`skill-repository-manager`](skills/tooling/skill-repository-manager/) | tooling | [`v1.0.0`](https://github.com/forrestwang-github/agent-skills/releases/tag/skill-repository-manager-v1.0.0) | [固定版本](https://github.com/forrestwang-github/agent-skills/tree/skill-repository-manager-v1.0.0/skills/tooling/skill-repository-manager) | 通过对话校验、安装、更新和发布个人 Skill。 |
<!-- skill-catalog:end -->
